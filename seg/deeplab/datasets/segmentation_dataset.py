...
_HOMEPLUS_INFORMATION = DatasetDescriptor(
    splits_to_sizes={
        'train': 2000,
        'trainval': 3000,
        'val': 1000,
...
_DATASETS_INFORMATION = {
    ...
    'homeplus': _HOMEPLUS_INFORMATION,
}
...
def get_dataset(dataset_name, split_name, dataset_dir):
  ...
  num_classes = _DATASETS_INFORMATION[dataset_name].num_classes  # 8

  ignore_label = _DATASETS_INFORMATION[dataset_name].ignore_label  # 255

  # file_pattern = _FILE_PATTERN  # '%s-*'
  file_pattern = os.path.join(dataset_dir, _FILE_PATTERN % split_name)  # tfrecord/val-*
